...
function rg_pfeeds_banner_import_page()
{
	global $wpdb;
	...
	{ 
		...
		$qry_response .= "<p><b>Your product feeds data subscription is ".$project_detail[0]->status.". </b><img  class='tick-icon' src=".RGPFEEDS_PLUGIN_URL. '/admin/images/tick_icon.png'." />  </p>";
	...
	?><div class="rg-admin-container">
		...
		<div id="sub_loader" align="center" style="display:none">
			<img src="<?php echo RGPFEEDS_PLUGIN_URL; ?>/admin/images/loading.gif" /></div>
		<hr>
				...
				<thead>
					...
					<tr>
						...
						<td class="store-table">
							<a href='rg_banners_import' class="rg_pfeeds_open_import_popup">Import</a> | <a href='rg_banners_delete' class="rg_pfeeds_open_delete_popup">Delete</a>
							...
							<a href="" id="rg_banner_import" class="rg_pfeeds_start_import" >Import</a> | <a href="javascript:{}" onClick="jQuery('#rg_pfeeds_import_popup').hide()">Cancel</a>
							</div>
							...
							<a href="" id="rg_banner_delete" class="rg_pfeeds_start_delete" >Delete</a> | <a href="javascript:{}" onClick="jQuery('#rg_pfeeds_delete_popup').hide()">Cancel</a>
							</div>
						</td>
					</tr>
			</table>
