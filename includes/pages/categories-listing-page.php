...
function rg_pfeeds_category_listing_page()
{
    global $wpdb;
	...
	<div class="rg-admin-container">
		...
		<hr/>
		<p>The categories you have selected at RevGlue are showing below. You may change them on RevGlue and run import categories link again from upload stores menu.</p>
		<table id="categories_admin_screen" class="display" cellspacing="0" width="100%">
			...
			{
				$parent_title = '';
				rg_pfeeds_populate_recursive_categories( $single_category, $parent_title, $counter );
				++$counter;
			} 
			?>
			</tbody>
